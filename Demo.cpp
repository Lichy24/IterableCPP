...
int main() {
	...
	for (auto p : zip(range(1, 6), string("hello")))
		cout << p << " ";    // 1,h  2,e  3,l  4,l  5,o
	cout << endl << endl << "Zip of zips" << endl;
	for (auto p : zip(zip(range(1, 4), string("xyz")), zip(string("abc"), range(6, 9))))
		cout << p << " ";   // 1,x,a,6  2,y,b,7  3,z,c,8
	
	cout << endl << endl << "Cartesian product of a range of ints and a string (can be of different sizes)" << endl;
	for (auto p : product(range(1, 4), string("hello")))
		cout << p << " ";    // 1,h  1,e  1,l  1,l  1,o  2,h  2,e  2,l  2,l  2,o  3,h  3,e  3,l  3,l  3,o
