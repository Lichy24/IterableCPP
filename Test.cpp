...
int main() {
	...
	if (signal == 0) {
		...
		std::string chainAns1 = "hello", chainAns2 = "123567", chainAns3 = "abcdhello", chainAns4 = "1,a 2,b 3,c 1,a 1,b 1,c 2,a 2,b 2,c 3,a 3,b 3,c", chainAns5 = "abcd12 this is a test";
		...
		std::string powersetAns1 = "{}{1}{2}{1,2}{3}{1,3}{2,3}{1,2,3}",powersetAns2= "{}{a}{b}{a,b}{x}{a,x}{b,x}{a,b,x}{y}{a,y}{b,y}{a,b,y}{x,y}{a,x,y}{b,x,y}{a,b,x,y}",powersetAns3= "{{}}{{1}}{{},{1}}{{2}}{{},{2}}{{1},{2}}{{},{1},{2}}{{1,2}}{{},{1,2}}{{1},{1,2}}{{2},{1,2}}{{},{1},{1,2}}{{},{2},{1,2}}{{1},{2},{1,2}}{{},{1},{2},{1,2}}",EmptyPowersetAns = "{}";
		std::stringstream ss;
		...
		for (auto i : chain(chain(range('a', 'e'),range(1,3)), chain(" this is a"," test")))
			ss << i;
		chain5 = ss.str();
		ss.str(std::string());
		...
		for (auto pair : zip(chain(range(1,4),string("adc")), product(range(4,7),string("ko"))))
			ss << pair;
		zip3 = ss.str();
		ss.str(std::string());
